...
Item {
    ...
    function getCycleMaster() {
        return cycleMaster;
    }
    ShortcutHandler {
        id: cycleMaster;

        name: "KrohnkiteCycleMaster";
        text: "Krohnkite: Cycle Master (next window to main tile)";
        sequence: "Meta+Tab";
    }
    function getCycleMasterBack() {
        return cycleMasterBack;
    }
    ShortcutHandler {
        id: cycleMasterBack;

        name: "KrohnkiteCycleMasterBack";
        text: "Krohnkite: Cycle Master Back (previous window to main tile)";
